...
function init_booked_fea()
{
    ...
    define('BOOKEDFEA_PLUGIN_URL', PWCAL_PLUGIN_URL . '/includes/add-ons/frontend-agents');
...
class Booked_FEA_Plugin
{
    ...
    {
        // Antes se encolaba para todo el mundo, incluidas las visitas
        // anonimas, que no pueden usar ninguna de estas acciones.
        ...
        $booked_fea_vars = [
            ...
            // Sin este nonce el servidor rechaza aprobar o cancelar citas.
            ...
            'i18n_confirm_appt_approve' => __(
                '¿Seguro que quieres aprobar esta cita?',
                'pw-calendario'
            ),
        ];
        wp_localize_script(
    ...
    public function booked_fea_tabs($custom_tabs)
    {
        $custom_tabs = [
            ...
            'fea_pending' => [
                'title' =>
                    __('Citas pendientes', 'pw-calendario') .
                    '<div class="counter"></div>',
                'booked-icon' => 'booked-icon-clock',
                'class' => false,
            ],
            'fea_history' => [
                'title' => __('Historial de citas', 'pw-calendario'),
                'booked-icon' => 'booked-icon-calendar',
                'class' => false,
            ],
            'edit' => [
                'title' => __('Editar el perfil', 'pw-calendario'),
