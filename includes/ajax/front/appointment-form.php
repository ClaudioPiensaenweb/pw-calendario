...
$availability_error = esc_html__( "Alguien ha reservado esta cita justo antes que tú. Elige otra hora.", 'pw-calendario' );
?>
<div class="booked-form booked-scrollable">
	...
	if ( $has_appts ) {
		include(PWCAL_AJAX_INCLUDES_DIR . 'front/appointment-form/form.php');
	}
...
<p class="booked-title-bar"><small><?php echo ( $new_appointment_default == 'draft' ? esc_html__('Solicitar una cita','pw-calendario') : esc_html__('Reservar una cita','pw-calendario') ); ?></small></p>
