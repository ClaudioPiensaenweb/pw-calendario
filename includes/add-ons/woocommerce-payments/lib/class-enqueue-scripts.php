...
class Booked_WC_EnqueueScript {
	...
	public function add_js_variables() {
		...
		$js_variables_array = array(
			...
			'i18n_confirm_appt_edit' => __('¿Seguro que quieres cambiar la fecha de la cita? Si lo haces, habrá que aprobarla de nuevo.', 'pw-calendario'),
			'i18n_pay' => __('¿Seguro que quieres añadir la cita al carrito e ir a la página de pago?', 'pw-calendario'),
			'i18n_mark_paid' => __('¿Seguro que quieres marcar esta cita como pagada?', 'pw-calendario'),
			'i18n_paid' => __('Pagada', 'pw-calendario'),
			'i18n_awaiting_payment' => __('Pendiente de pago', 'pw-calendario'),
