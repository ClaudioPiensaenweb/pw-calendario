	...
	class booked_appointments_post_type {
		...
		public function create_post_type() {
			...
			register_post_type('booked_appointments',
				array(
					'labels' => array(
						'name'               => esc_html__( 'Citas', 'pw-calendario' ),
						'singular_name'      => esc_html__( 'Cita', 'pw-calendario' ),
						'menu_name'          => esc_html__( 'Citas', 'pw-calendario' ),
						'name_admin_bar'     => esc_html__( 'Cita', 'pw-calendario' ),
						'add_new'            => esc_html__( 'Añadir nueva', 'pw-calendario' ),
						'add_new_item'       => esc_html__( 'Añadir una cita', 'pw-calendario' ),
						'new_item'           => esc_html__( 'Cita nueva', 'pw-calendario' ),
						'edit_item'          => esc_html__( 'Editar la cita', 'pw-calendario' ),
						'view_item'          => esc_html__( 'Ver la cita', 'pw-calendario' ),
						'all_items'          => esc_html__( 'Todas las citas', 'pw-calendario' ),
						'search_items'       => esc_html__( 'Buscar citas', 'pw-calendario' ),
						'parent_item_colon'  => esc_html__( 'Citas superiores:', 'pw-calendario' ),
						'not_found'          => esc_html__( 'No se han encontrado citas.', 'pw-calendario' ),
						'not_found_in_trash' => esc_html__( 'No hay citas en la papelera.', 'pw-calendario' )
					),
					'show_in_admin_bar' => false,
					'public' => false,
					'has_archive' => false,
					'description' => esc_html__('Citas','pw-calendario'),
					'supports' => array(
						'title','author'
					),
			...
			$labels = array(
				'name'                       => esc_html__( 'Calendarios personalizados', 'pw-calendario' ),
				'singular_name'              => esc_html__( 'Calendario personalizado', 'pw-calendario' ),
				'search_items'               => esc_html__( 'Buscar calendarios personalizados', 'pw-calendario' ),
				'popular_items'              => esc_html__( 'Calendarios personalizados más usados', 'pw-calendario' ),
				'all_items'                  => esc_html__( 'Todos los calendarios personalizados', 'pw-calendario' ),
				'parent_item'                => null,
				'parent_item_colon'          => null,
				'edit_item'                  => esc_html__( 'Editar el calendario personalizado', 'pw-calendario' ),
				'update_item'                => esc_html__( 'Actualizar el calendario personalizado', 'pw-calendario' ),
				'add_new_item'               => esc_html__( 'Añadir un calendario personalizado', 'pw-calendario' ),
				'new_item_name'              => esc_html__( 'Nombre del calendario personalizado', 'pw-calendario' ),
				'separate_items_with_commas' => esc_html__( 'Separa los calendarios personalizados con comas', 'pw-calendario' ),
				'add_or_remove_items'        => esc_html__( 'Añadir o quitar calendarios personalizados', 'pw-calendario' ),
				'choose_from_most_used'      => esc_html__( 'Elegir entre los calendarios más usados', 'pw-calendario' ),
				'not_found'                  => esc_html__( 'No se han encontrado calendarios personalizados.', 'pw-calendario' ),
				'menu_name'                  => esc_html__( 'Calendarios personalizados', 'pw-calendario' ),
			);
...
function booked_create_demo_appts($month = false,$year = false){
	...
	$month = isset($_GET['month']) ? absint( $_GET['month'] ) : false;
	$year = isset($_GET['year']) ? absint( $_GET['year'] ) : false;
	$calendar = isset($_GET['calendar']) ? absint( $_GET['calendar'] ) : false;
